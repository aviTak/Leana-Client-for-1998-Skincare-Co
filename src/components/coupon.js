...
import { getCouponsQuery } from '../queries/queries';
import { deleteCouponMutation } from '../queries/mutations';
...
class Coupon extends React.Component {
    ...
    submitForm(e){ 
        ...
        var data = this.props.getCouponsQuery;
    ...
    displayGrid(){ 
        ...
        const data = this.props.getCouponsQuery;
        ...
        if(mat.length !== 0){
            ...
            let a = mat.map(asset => (
                ...
                <tr key = {asset.id}>
                    ...
                    <td className = 'hover one'><Link style={{textDecoration: 'none'}} to = {'/coupon/title/' + asset.id}><div id={asset.id} style = {{width: '100%'}}>{asset.code}</div></Link></td>
    ...
    deletePost(id){
        ...
        this.props.deleteCouponMutation({
        ...
        return(
            <div className='main__show home__box all__box' id='testScroll' onScroll = { this.handleScroll }>
                <div className='home__main'>
                    ...
                    <Link to='/coupon/add' style={style}><div className = 'new__blog'>
...
export default compose(
    ...
    graphql(getCouponsQuery, {
        name: 'getCouponsQuery',
        options: () => ({
            variables: {
                search: undefined, 
                first: undefined, 
    ...
    graphql(deleteCouponMutation, {name: 'deleteCouponMutation'})
